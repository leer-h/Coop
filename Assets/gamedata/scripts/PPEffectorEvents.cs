...
public class PPEffectorEvents : MonoBehaviour
{
    ...
    {
        ppEffector.SetEffect(ppEffector.Chromatic, ppEffector.Chromatic.intensity, 0.5f, 1f);
        ppEffector.SetEffect(ppEffector.Panini, ppEffector.Panini.distance, 0.3f, 1f);
        ppEffector.SetEffect(ppEffector.White, ppEffector.White.temperature, -15f, 1f);
    }
